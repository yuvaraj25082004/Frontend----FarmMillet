...
@Composable
fun BajraTraceabilityScreen(navController: NavController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(modifier = Modifier
            ...
            Card(
                ...
                Column(
                    ...
                    Text("TR-2023-002", fontWeight = FontWeight.Bold, fontSize = 24.sp, color = Color(0xFF1B5E20))
                }
            }
...
private fun Timeline() {
    Column {
        TimelineItem("Harvested", "2023-11-20", "Harvested by Suresh Kumar in Mandya", Icons.Default.Eco, Color(0xFFE8F5E9), Color(0xFF1B5E20))
        TimelineItem("Processed & Packed", "2023-12-05", "Quality checked (Grade B) and packed by Mahila Shakti SHG", Icons.Default.VerifiedUser, Color(0xFFE3F2FD), Color(0xFF0D47A1))
        TimelineItem("Verified", "2023-12-05", "Quality assurance completed and verified", Icons.Default.CheckCircle, Color(0xFFF3E5F5), Color(0xFF673AB7), isLast = true)
    }
}
