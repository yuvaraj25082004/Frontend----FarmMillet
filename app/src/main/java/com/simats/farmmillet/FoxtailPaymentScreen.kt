...
@Composable
fun FoxtailPaymentScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("₹80.00", fontWeight = FontWeight.Bold, fontSize = 32.sp, color = Color(0xFF1FA74A))
            Spacer(modifier = Modifier.height(32.dp))
            OutlinedTextField(
                value = upiId,
            ...
            Button(
                onClick = { navController.navigate(AppRoutes.FOXTAIL_TRACK_ORDER) },
                modifier = Modifier.fillMaxWidth(),
