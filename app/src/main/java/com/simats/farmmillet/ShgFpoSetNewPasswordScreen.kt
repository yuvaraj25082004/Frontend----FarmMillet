...
@Composable
fun ShgFpoSetNewPasswordScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = { navController.navigate(AppRoutes.SHG_FPO_LOGIN) { popUpTo(AppRoutes.SHG_FPO_LOGIN) { this.inclusive = true } } },
