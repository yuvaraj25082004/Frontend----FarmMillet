...
@Composable
fun LittleMilletPaymentScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("₹75.00", fontWeight = FontWeight.Bold, fontSize = 32.sp, color = Color(0xFF1FA74A))
            Spacer(modifier = Modifier.height(32.dp))
            OutlinedTextField(
                value = upiId,
            ...
            Button(
                onClick = { navController.navigate(AppRoutes.LITTLE_MILLET_TRACK_ORDER) },
                modifier = Modifier.fillMaxWidth(),
