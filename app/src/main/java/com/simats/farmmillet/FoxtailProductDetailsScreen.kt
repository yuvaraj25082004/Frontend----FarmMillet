...
@Composable
fun FoxtailProductDetailsScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        bottomBar = {
            Row(
                ...
                Button(
                    onClick = { navController.navigate(AppRoutes.FOXTAIL_CHECKOUT) },
                    modifier = Modifier.weight(1f),
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.foxtail_millet_thinai),
                contentDescription = "Foxtail Millet (Thinai/Kangni)",
                modifier = Modifier
                    .fillMaxWidth()
                    .height(300.dp),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.Top) {
                    Text("Foxtail Millet (Thinai/Kangni)", fontWeight = FontWeight.Bold, fontSize = 24.sp)
                    Text("₹60/kg", fontWeight = FontWeight.Bold, fontSize = 24.sp, color = Color(0xFF1FA74A))
                }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    TextButton(onClick = { navController.navigate(AppRoutes.FOXTAIL_TRACEABILITY) }) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text("High fiber Foxtail millet.", color = Color.Gray)
                Spacer(modifier = Modifier.height(16.dp))
