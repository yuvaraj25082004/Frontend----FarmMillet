...
@Composable
fun BajraProductDetailsScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        bottomBar = {
            Row(
                ...
                Button(
                    onClick = { navController.navigate(AppRoutes.BAJRA_CHECKOUT) },
                    modifier = Modifier.weight(1f),
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.pearl_millet_bajra),
                contentDescription = "Pearl Millet (Bajra)",
                modifier = Modifier
                    .fillMaxWidth()
                    .height(300.dp),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.Top) {
                    Text("Pearl Millet (Bajra)", fontWeight = FontWeight.Bold, fontSize = 24.sp)
                    Text("₹38/kg", fontWeight = FontWeight.Bold, fontSize = 24.sp, color = Color(0xFF1FA74A))
                }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("4.2 / 5", fontSize = 14.sp)
                }
                Spacer(modifier = Modifier.height(16.dp))
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Icon(Icons.Default.Check, contentDescription = "Grade B Quality", tint = Color(0xFF1FA74A), modifier = Modifier.size(16.dp))
                    Text("Grade B Quality", color = Color(0xFF1FA74A), fontWeight = FontWeight.SemiBold)
                    Spacer(modifier = Modifier.weight(1f))
                    TextButton(onClick = { navController.navigate(AppRoutes.BAJRA_TRACEABILITY) }) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text("Fresh Bajra directly from farmers.", color = Color.Gray)
                Spacer(modifier = Modifier.height(16.dp))
