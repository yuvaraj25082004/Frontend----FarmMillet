...
@Composable
fun ConsumerSetNewPasswordScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = { navController.navigate(AppRoutes.CONSUMER_LOGIN) { popUpTo(AppRoutes.CONSUMER_LOGIN) { this.inclusive = true } } },
