...
@Composable
fun SorghumCheckoutScreen(navController: NavController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        bottomBar = {
            Button(
                onClick = { navController.navigate(AppRoutes.SORGHUM_PAYMENT) },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp),
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Text("₹62", fontWeight = FontWeight.Bold, color = Color(0xFF1FA74A))
                    }
                }
            }
        }
