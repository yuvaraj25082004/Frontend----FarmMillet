...
@Composable
fun FoxtailMilletOrderDetailsScreen(navController: NavController) {
    val order = OrderDetails(
        ...
        phone = "+91 9876543212",
        productName = "Foxtail Millet x 2kg",
        price = "₹120"
    )
        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text("Shipped", color = Color(0xFF9C27B0))
                    TextButton(onClick = { /*TODO*/ }) {
                        Text("Update Status ->", color = MaterialTheme.colorScheme.primary)
                    }
                    Spacer(modifier = Modifier.height(16.dp))
                    Divider()
                    Spacer(modifier = Modifier.height(16.dp))
            ...
            Card(
                ...
                Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
                    Icon(imageVector = Icons.Default.LocalShipping, contentDescription = null, tint = Color(0xFF9C27B0))
                    Spacer(modifier = Modifier.width(8.dp))
                    Text("Order is on the way", color = Color(0xFF9C27B0))
                }
            }
        }
    }
