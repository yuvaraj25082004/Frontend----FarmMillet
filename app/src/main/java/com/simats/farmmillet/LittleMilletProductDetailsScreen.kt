...
@Composable
fun LittleMilletProductDetailsScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        bottomBar = {
            Row(
                ...
                Button(
                    onClick = { navController.navigate(AppRoutes.LITTLE_MILLET_CHECKOUT) },
                    modifier = Modifier.weight(1f),
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.little_millet_samai),
                contentDescription = "Little Millet (Samai/Kutki)",
                modifier = Modifier
                    .fillMaxWidth()
                    .height(300.dp),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.Top) {
                    Text("Little Millet (Samai/Kutki)", fontWeight = FontWeight.Bold, fontSize = 24.sp)
                    Text("₹55/kg", fontWeight = FontWeight.Bold, fontSize = 24.sp, color = Color(0xFF1FA74A))
                }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    TextButton(onClick = { navController.navigate(AppRoutes.LITTLE_MILLET_TRACEABILITY) }) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text("Tiny grains packed with nutrition - Little Millet.", color = Color.Gray)
                Spacer(modifier = Modifier.height(16.dp))
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                 ...
                 Card(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(12.dp), colors = CardDefaults.cardColors(containerColor = Color.White)){
                    Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically){
                        Text("Total Price", fontWeight = FontWeight.Bold, fontSize = 18.sp, modifier = Modifier.weight(1f))
                        Text("₹55.00", fontWeight = FontWeight.Bold, fontSize = 24.sp, color = Color(0xFF1FA74A))
                    }
                 }
            }
        }
